...
if($_SESSION['status']=='admin_sv_h1'){
include "../connect.php"
?>
<!DOCTYPE html>
<html >
  ...
  <body>
	...
	<a style="color:#00F"> Welcome, <?php echo ($_SESSION['nama']) ?></a>
      ...
      <ul class="tab-group">
		...
		<li class="tab"><a href="#pdb">Pengajuan Data Dealer</a></li>
      ...
      <div class="tab-content">
        <div id="pdd">   
          ...
          <form id="form-search" method="post" action="submit_h1.php">
          <div class="top-row">
		  ...
		  <div class="field-wrap"><input type="text" value="" id="kode_dealer"/>
          </div>
          </div>
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is null and a.approval_sv is null and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h1' and a.nama_sv='$_SESSION[nama]' order by tanggal_pengajuan desc limit 0,10");
          ...
          <td align=center>";echo $baris['channel'];echo"</td>
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is null and a.approval_sv is null and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h1' order by tanggal_pengajuan desc");
					$count = 0;
        ...
        <div class="top-row" >
          ...
          <label>Tampilkan Halaman</label></div>
          <div class="field-wrap">
          <input type="number"required  style="width:15%" min="1" name="page" max="<?php echo ceil($count1/10)?>" value="1"/><span>Dari <?php echo ceil($count1/10) ?> halaman</span>
          </div>
        </div>
        </div>
        </form>
