...
if($_SESSION['status']=='admin_manager_h1'){
include "../connect.php"
?>
<!DOCTYPE html>
<html >
  ...
  <body>
    ...
    <div class="form">
	  ...
	  <div id="pdd">   
		  ...
		  <div class="field-wrap">
            <input id="comment_sv" name="comment_manager" type="text" value=""/>
          </div>
          </div>
		  <div class="top-row">
          <div class="field-wrap">
		  ...
		  <div class="field-wrap"><select id="approval_manager" name = "approval_manager">
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h1' and a.nama_manager='$_SESSION[nama]' order by tanggal_pengajuan desc limit 0,10");
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h1' order by tanggal_pengajuan desc");
					$count = 0;
