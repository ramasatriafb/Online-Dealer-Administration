	  ...
	  <div id="pdd">   
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h2' and a.nama_manager='$_SESSION[nama]' order by tanggal_pengajuan desc limit 0,10");
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h2' order by tanggal_pengajuan desc");
					$count = 0;
