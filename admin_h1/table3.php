<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.legalisir_admin = 'Complete' and a.jenis_pengajuan = 'Pengajuan Dealer Baru'";
	...
	if(!$_POST['channel']=="")
		...
		$sqlchannel = " and (a.channel = 'h2' or a.channel = 'h3')";
