...
<option value = "Pengajuan Dealer Baru">Pengajuan Dealer Baru</option>													
		  ...
		  <div class="table" >
                <table>
					...
					<td align=center><a href=upgrade_dealer_h1.php?id="; echo $baris['id_daftar']; echo ">Upgrade Channel Dealer</a></td></tr>";
					}
