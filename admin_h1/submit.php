...
if(!isset($_SESSION)) {
	...
	$query1 = mysql_query("INSERT INTO daftar_pengajuan ( id_admin, kode_dealer, tanggal_pengajuan, jenis_pengajuan, channel, status_channel, nama_sv, nama_manager, nama_divhead, jam_pengajuan ) VALUES ('$id_admin[id_admin]', '$_POST[kode_dealer]', '$date', 'Pengajuan Dealer Baru', 'H1', '$_POST[status_channel]', '$_POST[sv]', '$_POST[manager]', '$_POST[divhead]', '$time')");
	...
	$query3 = mysql_query("INSERT INTO channel_h1 (id_channel, pj, no_telp, no_fax, email, tgl_efektif, tgl_akhir, status_channel, status_bintang, cbo, waktucreate, waktumodify) VALUES ('$id_channel', '$_POST[pj]', '$_POST[no_telp]', '$_POST[no_fax]', '$_POST[email]', '$_POST[tgl_efektif]', '$_POST[tgl_akhir]', '$_POST[status_channel]', '$_POST[status_bintang]', '$_POST[cbo]', '$datetime', '$datetime')");
