...
<html >
  <head>
	...
	var _validFileExtensions = [".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".pdf",".png"];
...
<div class="top-row">
		  ...
		  <div class="field-wrap"><input name="kontak" type="number" required />
          </div>
          </div>
		  ...
		  <div class="field-wrap"><input name="no_telp" type="number" required />
          </div>
          </div>
		  ...
		  <div class="field-wrap"><input name="no_fax" type="text"/>
          </div>
          </div>
