...
include "../connect.php";
$sql=mysql_fetch_array(mysql_query("select * from daftar_pengajuan a, daftar_dealer b, kodepos c, channel_h3 d where a.id_daftar = '$_GET[id]' and a.kode_dealer = b.kode_dealer and b.id_kodepos = c.id_kodepos and b.kode_dealer = d.id_channel"));
?>
<!DOCTYPE html>
<html >
  <head>
    ...
    <div class="form">
      ...
      <div>
        <div id="h1">   
          ...
          <div class="field-wrap">
              <label>
              Comment Admin Super Visor<span class="req">*</span>:
            </label>
		  </div>
          ...
          <div class="field-wrap">
              <label>
              Comment Admin Manager Tujuan <span class="req">*</span>:
            </label>
		  </div>
          ...
          <div class="field-wrap">
              <label>
              Comment Admin Division Head Tujuan <span class="req">*</span>:
            </label>
		  </div>
