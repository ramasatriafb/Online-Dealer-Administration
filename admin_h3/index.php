        ...
        <div id="pdb">   
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.channel = 'H3' order by tanggal_pengajuan desc limit 0,10");
          ...
          <td align=center>";echo $baris['channel'];echo"</td>
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.channel = 'H3' order by tanggal_pengajuan desc");
					$count = 0;
        ...
        <div id="pdd">   
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.channel = 'h3' and a.legalisir_admin is null and (jenis_pengajuan = 'Pengajuan Dealer Baru' or jenis_pengajuan = 'Upgrade Channel') order by tanggal_pengajuan desc limit 0,10");
					while ($baris = mysql_fetch_array($hasil)){
					echo "
					<tr>
					<td align=center>";echo $baris['tanggal_pengajuan'];echo"</td>
					...
					<td align=center>";if($baris['approval_sv']=='Tidak Setuju'||$baris['approval_manager']=='Tidak Setuju'||$baris['approval_divhead']=='Tidak Setuju') echo "Rejected"; else if($baris['comment_sv']==null||$baris['approval_sv']==null||$baris['comment_manager']==null||$baris['approval_manager']==null||$baris['comment_divhead']==null||$baris['approval_divhead']==null) echo "In Progress";else echo "Acknowledged"; echo"</td>
          <td align=center>";echo $baris['channel'];echo"</td>
					<td align=center><a href=edit_dealer_h3.php?id="; echo $baris['id_daftar']; echo ">Edit</a> <a href=hapus_dealer_h3.php?id="; echo $baris['id_daftar'];echo"&kode=";echo $baris['kode_dealer']; echo ' onclick="return confirm';echo"('Anda Yakin Ingin Menghapus Pengajuan Dealer ".$baris['nama_dealer']." ?')";echo'" >Hapus</a></td></tr>';
					}
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.channel = 'h3' and a.legalisir_admin is null and (jenis_pengajuan = 'Pengajuan Dealer Baru' or jenis_pengajuan = 'Upgrade Channel') order by tanggal_pengajuan desc");
					$count1 = 0;
					while ($an = mysql_fetch_array($hitung))
					{
						$count1++;
