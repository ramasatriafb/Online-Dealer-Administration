        ...
        <div id="pdd">   
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is null and a.approval_sv is null and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h3' and a.nama_sv='$_SESSION[nama]' order by tanggal_pengajuan desc limit 0,10");
          ...
          <td align=center>";echo $baris['channel'];echo"</td>
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is null and a.approval_sv is null and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel='h3' order by tanggal_pengajuan desc");
					$count = 0;
