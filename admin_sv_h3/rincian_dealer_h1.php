...
$id=$_GET['id'];
if(isset($_SESSION['status'])&&$_SESSION['status']=='admin_sv_h1'){
include "../connect.php";
$sql=mysql_fetch_array(mysql_query("select * from daftar_pengajuan a, daftar_dealer b, kodepos c, channel_h1 d where a.id_daftar = '$id' and a.kode_dealer = b.kode_dealer and b.id_kodepos = c.id_kodepos and b.kode_dealer = d.id_channel"));
?>
<!DOCTYPE html>
<html >
  <head>
  ...
  <body>
    ...
    <div class="form">
      ...
      <div>
        ...
        <form name="edit" action="submit_h1.php?id=<?php echo $id ?>" method="post" onSubmit="validate()">
		  ...
		  <div class="field-wrap"><span><?php echo $sql['siop'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><span><?php echo $sql['tdp'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><span><?php echo $sql['ktp'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><span><?php echo $sql['npwp'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><span><?php echo $sql['ho'] ?></span>
          </div>
          </div>
		  <div class="top-row">
          <div class="field-wrap">
		  ...
		  <div class="field-wrap"><span><?php echo $sql['akte'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><span><?php echo $sql['surat_domisili'] ?></span>
          </div>
          </div>
		  ...
		  <div class="field-wrap"><input name="comment_sv" type="text" required />
          </div>
          </div>
		  ...
		  <div class="field-wrap"><select name = "approval_sv" required>
