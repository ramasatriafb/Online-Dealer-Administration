...
if(!isset($_SESSION)) {
	...
	$isi1 = mysql_query("UPDATE channel_h2 SET pj='$_POST[pj]',no_telp='$_POST[no_telp]',no_fax='$_POST[no_fax]',email='$_POST[email]',tgl_efektif='$_POST[tgl_efektif]',tgl_akhir='$_POST[tgl_akhir]',status_channel='$_POST[status_channel]',status_bintang='$_POST[status_bintang]',waktumodify='$datetime' WHERE id_channel='$kode_dealer'");
