<?php
	include "../connect.php";
	$sql= "select * from kodepos where kodepos is not NULL";
	if(!$_POST['kodepos']=="")
		$sqlkodepos = " and kodepos = '$_POST[kodepos]' "; 
	else 
		$sqlkodepos = " ";
	if(!$_POST['kelurahan']=="")
		$sqlkelurahan = " and kelurahan = '$_POST[kelurahan]' ";
	else
		$sqlkelurahan = " ";
	if(!$_POST['kecamatan']=="")
		$sqlkecamatan = " and kecamatan = '$_POST[kecamatan]' ";
	else
		$sqlkecamatan = " ";
	if(!$_POST['kabupaten']=="")
		$sqlkabupaten = " and kabupaten = '$_POST[kabupaten]' ";
	else
		$sqlkabupaten = " ";
