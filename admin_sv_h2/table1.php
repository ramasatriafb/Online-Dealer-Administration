<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is null and a.approval_sv is null and a.comment_manager is null and a.approval_manager is null and a.comment_divhead is null and a.approval_divhead is null and a.channel= 'h2' and a.nama_sv='$_SESSION[nama]' ";
	...
	while ($baris = mysql_fetch_array($hasil)){
		...
		<td align=center>";if($baris['comment_sv']==null||$baris['approval_sv']==null||$baris['comment_manager']==null||$baris['approval_manager']==null||$baris['comment_divhead']==null||$baris['approval_divhead']==null) echo "Need Approval"; else echo "Acknowledged"; echo"</td>
		<td align=center>";echo $baris['channel'];echo"</td>
		<td align=center><a href=";if($baris['channel']=='H1')echo"rincian_dealer_h1.php?id=";else if($baris['channel']=='H2')echo"rincian_dealer_h2.php?id=";else if($baris['channel']=='H3')echo"rincian_dealer_h3.php?id="; echo $baris['id_daftar']; echo ">Lihat Rincian</a></td></tr>";
