    ...
    <div class="form">
      ...
      <div>
        <div id="h1">   
         ...
         <form name="edit" action="submit_perpanjang_coba_h1.php?id=<?php echo $id ?>&kode=<?php echo $sql['kode_dealer'] ?>&sv=<?php echo $sql['nama_sv'] ?>&manager=<?php echo $sql['nama_manager'] ?>&divhead=<?php echo $sql['nama_divhead'] ?>" method="post" onSubmit="validate()">
