<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.status_channel = 'Percobaan' and legalisir_admin is not null and (a.jenis_pengajuan = 'Pengajuan Dealer Baru' or a.jenis_pengajuan = 'Upgrade Channel')";
