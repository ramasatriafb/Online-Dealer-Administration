<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.jenis_pengajuan = 'Pengangkatan Dealer Tetap'";
	...
	echo '</table></div></div><div class="top-row" >
          ...
          <div class="field-wrap">
          <input type="number" style="width:15%" min="1" name="page" max="';if(ceil($count3/10)==0)echo 1;else echo ceil($count3/10); echo'" value="'.$_POST['page'].'"/><span>Dari '.ceil($count3/10).' halaman</span>
          </div>
        </div>';
?>