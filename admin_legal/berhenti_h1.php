    ...
    <div class="form">
      ...
      <div>
        <div id="h1">   
         ...
         <form name="edit" action="submit_angkat_h1.php?id=<?php echo $id ?>&kode=<?php echo $sql['kode_dealer'] ?>" method="post" onSubmit="validate()">
		 ...
		 <div class="top-row">
		  ...
		  <div class="field-wrap"><input name="no_sp3d" type="text" required />
          </div>
          </div>
