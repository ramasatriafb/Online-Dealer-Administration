<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.jenis_pengajuan = 'Perpanjangan Masa Percobaan Dealer'";
	...
	echo '</table></div></div><div class="top-row" >
          ...
          <div class="field-wrap">
          <input type="number" style="width:15%" min="1" name="page" max="';if(ceil($count5/10)==0)echo 1;else echo ceil($count5/10); echo'" value="'.$_POST['page'].'"/><span>Dari '.ceil($count5/10).' halaman</span>
          </div>
        </div>';
?>