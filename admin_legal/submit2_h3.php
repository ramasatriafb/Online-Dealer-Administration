...
if(!isset($_SESSION)) {
	...
	if(!file_exists("../files/".$kode_dealer)&&!file_exists("../files/".$kode_dealer."/h3")){
	mkdir("../files/".$kode_dealer);
	mkdir("../files/".$kode_dealer."/h3");
	}
	...
	$lokasi_siop = '../files/'.$kode_dealer.'/h3/siop.'.$file_ext_siop;
	unlink('delete.txt');
	...
	$lokasi_tdp = '../files/'.$kode_dealer.'/h3/tdp.'.$file_ext_tdp;
	...
	$lokasi_ktp = '../files/'.$kode_dealer.'/h3/ktp.'.$file_ext_ktp;
	...
	$lokasi_npwp = '../files/'.$kode_dealer.'/h3/npwp.'.$file_ext_npwp;
	...
	$lokasi_ho = '../files/'.$kode_dealer.'/h3/ho.'.$file_ext_ho;
	...
	$lokasi_akte = '../files/'.$kode_dealer.'/h3/akte.'.$file_ext_akte;
	...
	$lokasi_surat_domisili = '../files/'.$kode_dealer.'/h3/surat_domisili.'.$file_ext_surat_domisili;
	...
	$sql1 =mysql_query("UPDATE daftar_pengajuan SET tanggal_pengajuan='$date' WHERE id_daftar='$id_daftar'");
	echo $sql1;
	...
	$isi1 = "UPDATE channel_h3 SET pj='$_POST[pj]',no_telp='$_POST[no_telp]',no_fax='$_POST[no_fax]',email='$_POST[email]',tgl_efektif='$_POST[tgl_efektif]',tgl_akhir='$_POST[tgl_akhir]',status_channel='$_POST[status_channel]',status_bintang='$_POST[status_bintang]'";
