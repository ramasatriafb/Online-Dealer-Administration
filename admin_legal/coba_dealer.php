...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Perpanjangan Masa Percobaan Dealer</title>
        ...
        <div id="pdd">   
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.legalisir_admin = 'Complete' and (a.jenis_pengajuan = 'Pengajuan Dealer Baru' or a.jenis_pengajuan = 'Upgrade Channel') and a.status_channel = 'Percobaan' and b.status_dealer <> 'Berhenti' order by tanggal_pengajuan desc limit 0,10");
					...
					<td align=center><a href=";if($baris['channel']=='H1')echo"perpanjang_coba_dealer_h1.php?id=";else if($baris['channel']=='H2')echo"perpanjang_coba_dealer_h2.php?id=";else if($baris['channel']=='H3')echo"perpanjang_coba_dealer_h3.php?id="; echo $baris['id_daftar']; echo ">Perpanjang Dealer</a></td></tr>";
					}
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.legalisir_admin = 'Complete' and (a.jenis_pengajuan = 'Pengajuan Dealer Baru' or a.jenis_pengajuan = 'Upgrade Channel') and a.status_channel = 'Percobaan' order by tanggal_pengajuan desc");
					$count = 0;
