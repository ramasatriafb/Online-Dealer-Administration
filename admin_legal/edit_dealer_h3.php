  ...
  <body>
    ...
    <div class="form">
      ...
      <div>
        ...
        <form name="edit" action="submit_h3.php?id=<?php echo $id ?>&kode=<?php echo $sql['kode_dealer'] ?>" method="post" onSubmit="validate()">
		  ...
		  <div class="field-wrap"><select name = "heps">
																			<option <?php if($sql['heps']=='Yes') echo "selected=selected"; ?> value = "Yes">Yes</option>
															<option <?php if($sql['heps']=='No') echo "selected=selected"; ?> value = "No">No</option>
															</select>
          </div>
          </div>
...
<a href="<?php echo $sql['akte'] ?>" target="_blank">Preview</a>          </div>
          ...
          <div class="field-wrap">
              <label>
              Admin Super Vicer Tujuan <span class="req">*</span>:
            </label>
		  </div>
		  <div class="field-wrap"><input name="sv" type="text"  list="svlist" value="<?php echo $sql['nama_sv'] ?>" required />
          <datalist id="svlist">
          <?php
		  $listsv=mysql_query("select nama from admin where status = 'admin_sv_h3'");
          ...
          <?php
		  $listmanager=mysql_query("select nama from admin where status = 'admin_manager_h3'");
          ...
          <?php
		  $listdivhead=mysql_query("select nama from admin where status = 'admin_divhead_h3'");
