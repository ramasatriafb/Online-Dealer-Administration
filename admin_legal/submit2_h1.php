...
if(!isset($_SESSION)) {
	...
	if(!file_exists("../files/".$kode_dealer)&&!file_exists("../files/".$kode_dealer."/h1")){
	mkdir("../files/".$kode_dealer);
	mkdir("../files/".$kode_dealer."/h1");
	}
	...
	$lokasi_siop = '../files/'.$kode_dealer.'/h1/siop.'.$file_ext_siop;
	unlink('delete.txt');
	...
	$lokasi_tdp = '../files/'.$kode_dealer.'/h1/tdp.'.$file_ext_tdp;
	...
	$lokasi_ktp = '../files/'.$kode_dealer.'/h1/ktp.'.$file_ext_ktp;
	...
	$lokasi_npwp = '../files/'.$kode_dealer.'/h1/npwp.'.$file_ext_npwp;
	...
	$lokasi_ho = '../files/'.$kode_dealer.'/h1/ho.'.$file_ext_ho;
	...
	$lokasi_akte = '../files/'.$kode_dealer.'/h1/akte.'.$file_ext_akte;
	...
	$lokasi_surat_domisili = '../files/'.$kode_dealer.'/h1/surat_domisili.'.$file_ext_surat_domisili;
	...
	$sql1 =mysql_query("UPDATE daftar_pengajuan SET tanggal_pengajuan='$date',nama_sv='$_POST[sv]', nama_manager='$_POST[manager]', nama_divhead='$_POST[divhead]', WHERE id_daftar='$id_daftar'");
	echo $sql1;
	$sql2 =mysql_query("UPDATE daftar_dealer SET nama_dealer='$_POST[nama_dealer]',id_kodepos='$idkodepos[id_kodepos]',lokasi='$_POST[lokasi]',owner='$_POST[owner]',kontak='$_POST[kontak]',status_tanah='$_POST[status_tanah]',akhir_sewa='$_POST[akhir_sewa]',waktumodify='$datetime' WHERE kode_dealer = '$kode_dealer'");
	echo $_POST['nama_dealer'];
	$isi1 = "UPDATE channel_h1 SET pj='$_POST[pj]',no_telp='$_POST[no_telp]',no_fax='$_POST[no_fax]',email='$_POST[email]',tgl_efektif='$_POST[tgl_efektif]',tgl_akhir='$_POST[tgl_akhir]',status_channel='$_POST[status_channel]',status_bintang='$_POST[status_bintang]', cbo='$_POST[cbo]'";
	...
	$isi9 = ",waktumodify='$datetime' WHERE id_channel='$kode_dealer'";
	$sql3 =mysql_query($isi1.$isi2.$isi3.$isi4.$isi5.$isi6.$isi7.$isi8.$isi9);
	echo $sql3;
