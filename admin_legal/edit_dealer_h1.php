  ...
  <body>
    ...
    <div class="form">
      ...
      <div>
        ...
        <form name="edit" action="submit_h1.php?id=<?php echo $id ?>&kode=<?php echo $sql['kode_dealer'] ?>" method="post" onSubmit="validate()">
		  ...
		  <div class="field-wrap"><select name = "cbo">
															<option <?php if($sql['cbo']=='Yes') echo "selected=selected";?>  value = "Yes">Yes</option>
															<option <?php if($sql['cbo']=='No') echo "selected=selected";?> value = "No">No</option>
															</select>
          </div>
          </div>
...
<a href="<?php echo $sql['akte'] ?>" target="_blank">Preview</a>          </div>
          ...
          <?php
		  $listmanager=mysql_query("select nama from admin where status = 'admin_manager_h1'");
          ...
          <?php
		  $listdivhead=mysql_query("select nama from admin where status = 'admin_divhead_h1'");
		...
		<div class="top-row">
		  ...
		  <div class="field-wrap"><input name="no_sp3d" type="text"value="<?php echo $sql['no_sp3d'] ?>" required />
          </div>
          </div>
