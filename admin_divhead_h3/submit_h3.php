...
if(!isset($_SESSION)) {
	...
	$sql1 =mysql_query("UPDATE channel_h3 SET tgl_akhir = '$querry2[perpanjangan]' WHERE id_channel='$querry2[kode_dealer]'");
	$querry3 = mysql_fetch_array(mysql_query("select * from daftar_pengajuan where id_daftar ='$id[$i]' and status_channel is not null"));
	$sql4 =mysql_query("UPDATE channel_h3 SET status_channel = '$querry3[status_channel]' WHERE id_channel='$querry3[kode_dealer]'");
