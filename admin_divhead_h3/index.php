...
if($_SESSION['status']=='admin_divhead_h3'){
include "../connect.php"
?>
<!DOCTYPE html>
<html >
    ...
    <div class="form">
	 ...
	 <a style="color:#00F"> Welcome, <?php echo ($_SESSION['nama']) ?></a>
	  ...
	  <div id="pdd">   
          ...
          <form id="form-search" method="post" action="submit_h3.php">
          <div class="top-row">
		  ...
		  <div class="field-wrap">
            <input id="comment_sv" name="comment_divhead" type="text" value=""/>
          </div>
          </div>
		  <div class="top-row">
          <div class="field-wrap">
		  ...
		  <div class="field-wrap"><select id="approval_divhead" name = "approval_divhead">
		  ...
		  <div class="table" >
                <table>
					...
					$awal = date('Y-m-01');
					$akhir = date('Y-m-t');
					$hasil=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is not null and a.approval_manager = 'Setuju' and a.comment_divhead is null and a.approval_divhead is null and a.channel='h3' and a.nama_divhead='$_SESSION[nama]' order by tanggal_pengajuan desc limit 0,10");
					...
					$hitung=mysql_query("select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv = 'Setuju' and a.comment_manager is not null and a.approval_manager = 'Setuju' and a.comment_divhead is null and a.approval_divhead is null and a.channel='h3' order by tanggal_pengajuan desc");
					$count = 0;
