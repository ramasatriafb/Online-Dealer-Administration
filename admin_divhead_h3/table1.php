<?php
	include "../connect.php";
	$sql= "select * from daftar_pengajuan a, daftar_dealer b where a.kode_dealer = b.kode_dealer and a.comment_sv is not null and a.approval_sv ='Setuju' and a.comment_manager is not null and a.approval_manager = 'Setuju' and a.comment_divhead is null and a.approval_divhead is null and a.channel= 'h3' and a.nama_divhead='$_SESSION[nama]'";
